...
import { normalizeRemoteUrl, detectGitToplevel, getRemoteUrls, resolveProjectIdentity, bustIdentityCache } from "../../mcp-server/identity.js";
...
export async function runIdentityTests() {
  console.log("--- Running Unit Tests: identity ---");
  ...
  // Add remote
  execFileSync(GIT_CMD, ["-C", tempRepoDir, "remote", "add", "origin", "https://github.com/dummy/fake-repo.git"]);
...
if (process.argv[1] && process.argv[1].endsWith("identity.test.js")) {
